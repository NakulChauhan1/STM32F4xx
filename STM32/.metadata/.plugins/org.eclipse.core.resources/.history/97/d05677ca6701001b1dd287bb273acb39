...
/* Now it's time for writing addresses of registers of each peripheral*/
...
// for enabling/disabling clock we need RCC section, so we need to have access to base addresses of RCC registers,
